...
class BotThread(threading.Thread):
    ...
    def run(self):
        ...
        revid = self.change['revid']
        if self.page.latest_revision_id == revid:
            self.change['revision']['new'] = self.page.get()
        else:
            self.change['revision']['new'] = self.page.getOldVersion(revid)
